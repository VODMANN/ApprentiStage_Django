...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Entreprise',
            fields=[
                ('numSiret', models.CharField(max_length=100, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_utilisateur', models.CharField(choices=[('etudiant', 'Etudiant'), ('enseignant', 'Enseignant'), ('secretaire', 'Secrétaire')], default='etudiant', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contrat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lesApprentiStage.contrat')),
            ],
        ),
        migrations.AddField(
            model_name='contrat',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('numHarpege', models.CharField(max_length=20, primary_key=True, serialize=False)),
                ...
                ('roleEnseignant', models.CharField(choices=[('chef_departement', 'Chef de Département'), ('enseignant_normal', 'Enseignant Normal'), ('enseignant_promo', 'Enseignant de Promo')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chef', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='lesApprentiStage.profilenseignant')),
            ],
        ),
        migrations.AddField(
            model_name='contrat',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numEtu', models.CharField(max_length=35, primary_key=True, serialize=False)),
                ...
                ('idDepartement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lesApprentiStage.departement')),
                ('utilisateur', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='contrat',
            name='etudiant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lesApprentiStage.profiletudiant'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lesApprentiStage.departement')),
            ],
        ),
        migrations.AddField(
            model_name='profiletudiant',
            name='promo',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lesApprentiStage.promo'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entreprise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lesApprentiStage.entreprise')),
            ],
        ),
        migrations.CreateModel(
            name='Soutenance',
            fields=[
                ...
                ('candide', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='lesApprentiStage.profilenseignant')),
                ('idContrat', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='lesApprentiStage.contrat')),
                ('salle', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='lesApprentiStage.salle')),
            ],
        ),
        migrations.CreateModel(
            name='Offre',
            fields=[
                ...
                ('entreprise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lesApprentiStage.entreprise')),
                ('theme', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lesApprentiStage.theme')),
            ],
        ),
        migrations.AddField(
            model_name='contrat',
            name='theme',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lesApprentiStage.theme'),
        ),
        migrations.CreateModel(
            name='Tuteur',
            fields=[
        ...
        migrations.AddField(
            model_name='contrat',
            name='tuteur',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='lesApprentiStage.tuteur'),
        ),
        migrations.CreateModel(
